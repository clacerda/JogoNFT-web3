...
contract MyEpicGame is ERC721 {
        ...
        ERC721("Heroes", "HERO")
    {
        ...
        //O código do outro personagem está aqui embaixo do mesmo jeito que antes, só não estamos mostrando para manter as coisas simples!
    ...
    function attackBoss() public {
        ...
        console.log(
            "\nAo custo de sua sanidade %s ira atacar. Tem %s de HP e %s de PA",
            player.name,
            player.hp,
            player.attackDamage
        );
